...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (use-package counsel-projectile zop-to-char swiper-helm textmate dash-functional elm-mode sicp intero csv-mode terraform-mode yari yaml-mode yafolding wrap-region web-mode visual-regexp utop unkillable-scratch undo-tree tuareg toml-mode sws-mode swift-mode string-inflection soft-morning-theme smooth-scrolling smex smartscan smartparens smart-tab slime shorten shell-here scss-mode sass-mode rustfmt ruby-tools ruby-refactor ruby-hash-syntax rubocop rspec-mode rotate robe rinari rhtml-mode restclient rainbow-mode rainbow-delimiters racket-mode racer pretty-lambdada popwin pallet ox-reveal org-repo-todo oauth2 names mustache-mode multiple-cursors multi-term multi-compile move-text mode-compile memory-usage markdown-mode mark-multiple magit lui levenshtein less-css-mode lcs know-your-http-well key-combo json-mode js2-mode ido-ubiquitous idle-highlight-mode helm-themes helm-rails helm-projectile helm-open-github helm-ls-git helm-lobsters helm-hoogle helm-google helm-dash helm-cmd-t helm-bundle-show helm-ag helm-ack handlebars-mode grizzl goto-last-change goto-chg golden-ratio go-mode github-browse-file git-gutter gist gh-md ggtags full-ack flycheck-rust flycheck-pos-tip flycheck-package flycheck-ocaml flycheck-color-mode-line flycheck-clojure flycheck-cask flx-ido find-file-in-project feature-mode expand-region exercism exec-path-from-shell etags-select erlang emr elixir-yasnippets elixir-mix elisp-slime-nav elein dired-details dash-at-point ctags-update ctable coffee-mode cargo bundler browse-kill-ring base16-theme autopair auto-complete arduino-mode anzu alchemist aggressive-indent ack-and-a-half ace-jump-mode 4clojure)))
