...
(custom-set-variables
 ...
 '(erc-modules (quote (autojoin completion ring smiley stamp hl-nicks image completion autojoin fill list ring services ercn netsplit button match track readonly networks noncommands irccontrols move-to-prompt stamp menu)))
 '(erc-nick nil)
