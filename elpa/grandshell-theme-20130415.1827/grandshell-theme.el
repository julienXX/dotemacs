...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(helm-source-header ((,class (:background ,background, :foreground ,blue, :underline t, :weight bold))))
   ...
   `(diredp-dir-heading ((,class (:inherit minibuffer-prompt))))
   `(diredp-dir-priv ((,class (:foreground ,cyan :background nil))))
   `(diredp-exec-priv ((,class (:foreground ,green :background nil))))
   `(diredp-executable-tag ((,class (:foreground ,red :background nil))))
   `(diredp-file-name ((,class (:foreground ,green))))
