...
#+begin_src emacs-lisp
  (use-package mu4e
    :ensure nil
    :defer t
    :load-path "/opt/homebrew/Cellar/mu/1.12.15/share/emacs/site-lisp/mu/mu4e")
#+end_src
...
#+begin_src emacs-lisp
  (use-package eglot
    ...
    (add-to-list 'eglot-server-programs
                 '((ruby-ts-mode ruby-mode) . ("bundle" "exec" "ruby-lsp")))
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'flycheck
    ...
    ;; Chain sorbet after rubocop (runs regardless of rubocop result)
    (add-to-list 'flycheck-checkers 'ruby-sorbet t)  ;; append so ruby-rubocop stays first
    (flycheck-add-next-checker 'ruby-rubocop '(t . ruby-sorbet))
