...
#+begin_src emacs-lisp
  (use-package lsp-mode
    ...
    (setq lsp-keymap-prefix "C-c l"
          lsp-disabled-clients '(ruby-lsp typeprof-ls)
          ...
          ;; Header line breadcrumbs
          lsp-headerline-breadcrumb-enable t

          ;; Modeline diagnostics
          lsp-modeline-diagnostics-enable t

          ;; Enable multiple servers per buffer
          lsp-prefer-flymake nil

          ;; IMPORTANT: Auto-configure xref to use LSP
          lsp-auto-configure t)
    :config
    (require 'ht)

    ;; Load built-in Ruby LSP clients early
    (require 'lsp-sorbet)
    (require 'lsp-rubocop)
    :hook
  ...
  (with-eval-after-load 'lsp-mode
    ...
    ;; Remove built-in clients that only work with ruby-mode
    (remhash 'sorbet-ls lsp-clients)
    (remhash 'rubocop-ls lsp-clients)

    ;; Re-register Sorbet with ruby-ts-mode support
    (lsp-register-client
     (make-lsp-client
      :new-connection (lsp-stdio-connection
                       (lambda () '("bundle" "exec" "srb" "typecheck" "--lsp" "--disable-watchman")))
      :major-modes '(ruby-mode ruby-ts-mode)
      :priority 10
      :server-id 'sorbet-ls))

    ;; Re-register Rubocop with ruby-ts-mode support
    (lsp-register-client
     (make-lsp-client
      :new-connection (lsp-stdio-connection
                       (lambda () '("bundle" "exec" "rubocop" "--lsp")))
      :major-modes '(ruby-mode ruby-ts-mode)
      :priority -1
      :add-on? t
